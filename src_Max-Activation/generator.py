...
class WatermarkedGenerator:
    ...
    def generate(
        ...
        for step in range(max_tokens):
            ...
            # --- Step 2: TARGET FEATURE (Max-Activation Index) ---
            # h_last = h_t[0, -1, :] đã được lấy ở trên
            seed = get_max_activation_seed(h_last, secret_key)
            ...
            if entropy.item() < 2.0: 
                ...
                # Khuếch đại tín hiệu: Ép giá trị lớn nhất vọt lên mức 2.0
